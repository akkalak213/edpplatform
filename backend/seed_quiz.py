...
def seed_questions():
    ...
    # ลบคำถามเก่าทั้งหมดก่อน เพื่อไม่ให้ซ้ำซ้อน
    db.query(edp.QuizQuestion).delete()
    db.commit()

    questions = [
        # --- ด้านที่ 1: ความคิดริเริ่ม (Originality) ---
        {
            "question_text": "1. หากต้องการแก้ปัญหาน้ำท่วมขังในหมู่บ้านโดยไม่ใช้เครื่องสูบน้ำ แนวทางในข้อใดสะท้อนความคิดริเริ่มได้ดีที่สุด?",
            "choices": [
    ...
    db.commit()
    print("Seeded 40 new questions successfully.")
